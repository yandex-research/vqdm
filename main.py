...
def add_aqlm_engine_args(parser):
    ...
    parser.add_argument(
        ...
        type=str,
        default="int32",
        help="if specified, cast quantized layers' codes to this dtype",
    )
    parser.add_argument(
        "--out_group_size",
        type=int,
    ...
    parser.add_argument(
        "--group_channels",
        action="store_true",
        help="When quantizing conv layers, this option will group input channels within one location."
        "Otherwise, it will prioritize grouping different locations within the same input channel. Only affects conv layers",
    )
    parser.add_argument(
